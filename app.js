...
/**
 * Loads initial data from localStorage or fetches the default JSON file.
 */
...
/**
 * Fetches the default_data.json file and loads it into the application.
 */
...
/**
 * Saves the current data state to a JSON file and localStorage.
 */
function saveData() {
    try {
